...
@Component
public class ChinaStockPaymentReport implements ReportInterface {
	...
	@Autowired
	public ChinaStockPaymentReport(ExpenseService expenseService,
	...
	public Workbook exportReport(Workbook workbook, Date dateAsOf, Date endDate,
		...
		Sheet sheet = workbook.createSheet("RMB Payment");
