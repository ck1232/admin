...
import com.admin.filemgmt.utils.ImageSequenceCompare;
...
import com.admin.productcategorymgmt.service.ProductCategoryMgmtService;
import com.admin.productmanagement.vo.ProductAttributeGroupVO;
...
import com.admin.productmanagement.vo.ResponseProductVO;
import com.admin.productmgmt.service.ProductMgmtService;
import com.admin.productmgmt.service.ProductTagsService;
...
public class ProductMgmtController {
	...
	public @ResponseBody String getProductList() {
		...
		List<ProductVO> productList = productMgmtService.getProductList(null);
	...
	public String createProduct(HttpSession session, Model model){
		...
		List<ProductCategoryVO> productCategoryVOList = productCategoryMgmtService.getAllProductCategoryList();
	...
	public String editProduct(HttpSession session, Model model, @RequestParam("editBtn") Long id){
		...
		if(id != null){
			List<ProductVO> productList = productMgmtService.getProductList(Arrays.asList(id));
	...
	public @ResponseBody List<String> getProductOptionList(HttpSession session) {
		...
		if(allProductOptionVOList == null){
			allProductOptionVOList = productOptionMgmtService.getAllProductOptions();
	...
	public String saveProduct(HttpSession session, @ModelAttribute("productForm") ResponseProductVO responseProduct, final RedirectAttributes redirectAttributes){
		...
		productMgmtService.saveAddProduct(newProduct);
