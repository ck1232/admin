...
//	private static final Logger logger = Logger.getLogger(GrantService.class);
	...
	@Override
	public List<InvoiceVO> getAllGrant(Date dateAsOf, Date endDate) {
		List<GrantTO> grantList = grantDAO.findByGrantDateBetweenAndDeleteInd(dateAsOf, endDate, GeneralUtils.NOT_DELETED);
		return convertToInvoiceVOList(grantList);
	}
}
